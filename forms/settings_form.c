...
static Button_Struct_t Normal_Botton, ChargeFirst_Botton, UseFrist_Botton,
        SucapTest_Botton, Uart_Button; // To switch Setting_OptiSchemes
...
void Uart_Button_Callback(void *object, unsigned char key) {
    Form_Info_Structure.Form_Index = UartDebuger_Index;
    UartDebugerForm_Init();
}
...
void SettingsForm_Init(void) {
    ...
    TurnBack_Button2.NextButton = &Uart_Button;
    TurnBack_Button2.CallbackFunction = TurnBack_Button2_Callback;

    Uart_Button.X_Pos = 2;
    Uart_Button.Y_Pos = 98;
    Uart_Button.Width = 80;
    Uart_Button.Height = 22;
    Uart_Button.Text = "Uart";
    Uart_Button.NextButton = NULL;
    Uart_Button.CallbackFunction = Uart_Button_Callback;
